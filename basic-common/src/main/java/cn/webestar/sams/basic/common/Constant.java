...
public class Constant {
    ...
    public static class AUTH {
         ...
         * token key 的key格式
         */
        public final static String ACCESS_TOKEN_CACHE_KEY = "security:accessToken:%s:%s";

        /**
         * refresh_token 的key格式
         */
        public final static String REFRESH_TOKEN_CACHE_KEY = "security:refreshToken:%s:%s";

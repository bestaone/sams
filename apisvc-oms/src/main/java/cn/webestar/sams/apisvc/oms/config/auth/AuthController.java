...
import cn.webestar.sams.apisvc.oms.api.dto.AccountLoginDTO;
import cn.webestar.sams.apisvc.oms.api.dto.SmsLoginDTO;
...
import cn.webestar.sams.microsvc.oms.api.UserApi;
import cn.webestar.sams.microsvc.oms.domain.User;
import cn.webestar.sams.microsvc.oms.dto.user.UserSimpleBody;
...
public class AuthController {
    ...
    private final static Integer expireIn = OmsConstant.AUTH.ACCESS_TOKEN_EXPIRE;
    ...
    public R<LoginVO> accountLogin(HttpServletRequest request, HttpServletResponse response, @RequestBody AccountLoginDTO body){
        ...
        SessionContext context = AuthContextHolder.setAuthentication(auth);
